...
// Plaintext sources live in ~/Library/Mobile Documents/com~apple~CloudDocs/command-center/private-pages/<slug>.html — never in a repo.
...
const ct = await crypto.subtle.encrypt({ name: 'AES-GCM', iv }, key, readFileSync(`${homedir()}/Library/Mobile Documents/com~apple~CloudDocs/command-center/private-pages/${slug}.html`));
